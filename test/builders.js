import tap from 'tap';
import { standardImport, dynamicImport, sideEffectsImport } from '../src/builders.cjs';
...
tap.test('.standardImport() - Replace module name', (t) => {
    ...
    t.matchSnapshot(result.source, 'should replaced matched values with dictionary values');
    t.end();
});
